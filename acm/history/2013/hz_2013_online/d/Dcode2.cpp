...
void calMinDist()
{
	...
	{
		//求交点
		//Point3D a1_b1 = v12;//calVector(s2, s1);
		//Point3D v1_v2 = vn;//calCrossVector(v1, v2);
		Point3D v2_a1_b1 = calCrossVector(v2, v12);
		Point3D v1_a1_b1 = calCrossVector(v1, v12);

		float na = calMulVector(v2_a1_b1, vn);
		float nb = calMulVector(v1_a1_b1, vn);
		float d = mol_vn;//calMulVector(vn, vn);
